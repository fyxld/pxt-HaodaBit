...
*/
    ...
    export class Strip {
         ...
         */
        //% blockId="HaodaBit_set_strip_color" block="%strip|show color %rgb=neopixel_colors" 
         ...
         * @param rgb RGB color of the LED
         */
        //% blockId="HaodaBit_set_pixel_color" block="%strip|set pixel color at %pixeloffset|to %rgb=neopixel_colors" 
        //% blockGap=8
        //% weight=80
        //% group="RGB" 
